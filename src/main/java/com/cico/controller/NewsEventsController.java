...
public class NewsEventsController {
	...
	public ResponseEntity<ApiResponse> createNewsEvents(
	        @RequestParam("shortDescriptoin") String shortDescription,
	    ...
	    return new ResponseEntity<>(
	        new ApiResponse(Boolean.TRUE, AppConstants.CREATE_SUCCESS, HttpStatus.CREATED),
	        HttpStatus.CREATED
	    );
	}
