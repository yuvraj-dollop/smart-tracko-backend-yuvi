...
public class DiscussionFormController {
	...
	@PostMapping(value = "v2/createDiscussionForm", consumes = MediaType.MULTIPART_FORM_DATA_VALUE)
	public ResponseEntity<?> createDiscussionForm(
			@Valid @ModelAttribute CreateDiscussionFormRequest discussionFormRequest) {
