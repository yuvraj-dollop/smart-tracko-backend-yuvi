...
//		        emailService.sendEmail(student.getEmail(), TemplateType.OTP_LOGIN, placeholders);
		...
		return ApiResponse
				.builder()
				.success(true)
				.message(AppConstants.OTP_SENT_FOR_LOGIN)
				.http(HttpStatus.OK)
				.data(res)
				.build();
	}
	...
	public ApiResponse adminLogin(AdminLoginRequest loginRequest) {
		...
		String authToken = jwtUtil
				.generateTokenForAdmin(
				admin.getAdminEmail(), // subject
				TokenType.AUTH_TOKEN,
				OtpType.LOGIN,false);
...
//		}
	...
	public ApiResponse forgotPassword(ForgetPasswordRequest request) {
		...
		return ApiResponse
				.builder()
				.success(true)
				.message(AppConstants.OTP_SENT_FOR_RESET_PASSWORD)
				.http(HttpStatus.OK)
				.data(res)
				.build();
	}
	...
	public ApiResponse resetPassword(ResetPasswordRequest request) {
		...
		return ApiResponse
				.builder()
				.success(true)
				.message(AppConstants.PASSWORD_RESET_SUCCESSFULLY)
	...
	public ApiResponse resendOtp() {
	    ...
	    TokenType tokenType = TokenType
	    		.valueOf(jwtUtil.getHeader(oldToken, "tokenType").toString());
	    OtpType otpType = OtpType
	    		.valueOf(jwtUtil.getHeader(oldToken, "otpType").toString());
	    
	    String role = String
	    		.valueOf(jwtUtil.getHeader(oldToken, "Role"));
	    ...
	    if ("STUDENT".equalsIgnoreCase(role)) {
	        ...
	        newToken = jwtUtil.generateTokenForStudent(
	                student.getStudentId().toString(),
	                student.getUserId(),
	                student.getDeviceId(),
	                student.getRole(),
	        ...
	        newToken = jwtUtil.generateTokenForAdmin(
	                admin.getAdminEmail(),
	                TokenType.AUTH_TOKEN,
	                otpType,
	                false
	...
	public ApiResponse verifyOtp(OtpRequest otpRequest) {
	    ...
	    return ApiResponse.builder()
	            .success(true)
	            .message(AppConstants.OTP_VERIFIED_SUCCESSFULLY)
	            .http(HttpStatus.OK)
	            .data(res)
	            .build();
	}
