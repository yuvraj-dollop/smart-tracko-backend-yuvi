...
public class AppConstants {
	...
	public static final int RANDOM_QUESTION_SIZE = 2;

	public static final String TIMER = "timer";

	public static final String SUBJECT_EXAM = "subjectExam";

	public static final String NORMAL_EXAM = "normlaExam";

	public static final String SCHEDULE_EXAM = "scheduleExam";

	public static final String EXAM_ADDED_SUCCESSFULLY = "exam successfully added!!";

	public static final String EXAM_ALREADY_GIVEN = "you already given this exam!!";

	public static final String EXAM_ALREADY_PRESENT_WITH_THIS_NAME = "Exam already present with name!! ";
	...
	public static final String IMAGES = "update-user";

	public static final String TASK_ALREADY_EXISTS = "Task already exists";
//	public static final String CREATE_SUCCESS = "Task created successfully";
...
//	public static final String NEW_TASK_ADDED_SUCCESSFULLY = "New task added successfully";
	public static final String IS_NEW_TASK = "isNewTask";
	public static final String ADD_QUESTION_IN_TASK = "Please add some question in task";
//	public static final String TASK_ASSIGNMENT_FILES = "task_assignment_files";
	public static final String ZIP = "zip";
//	public static final String QUESTION = "question";
	public static final String ALREADY_TASK_SUBMITTED = "Task already submitted";
	public static final String CREATED_DATE = "createdDate";

	public static final String DATA = "data";

	public static final String NO_QUESTION_AVAILABLE = "no question available for this exam!!";

	public static final String NO_RESUTL_FOUND = "no result found for this exam!!";

	public static final String TASK_SUBMITTED_SUCCESSFULLY = "Task  submitted successfully!!";
...
// ===========================YUVI================================
	...
	public static final String MAX_TITLE_LENGTH = "Title must not exceed 100 characters";
	...
	public static final String SHORT_DESCRIPTION_MAX_SIZE = "Short description cannot exceed 255 characters";

	public static final String TECHNOLOGY_STACK_ID_REQUIRED = "Technology stack ID is required";

	public static final String MIN_SUBJECT_ID = "At least one subject ID must be provided";

	public static final String SUBJECT_ID_NOT_NULL = "Subject ID cannot be null";
	...
	public static final String FUTURE_START_DATE = "Batch start date cannot be in the past";

	public static final String BATCH_TIMING_REQUIRED = "Batch timing is required";

	public static final String BATCH_DETAIL_REQUIRED = "Batch details are required";
	...
	public static final String FCM_ID_REQUIRED = "FCM ID must not be blank";

	public static final String DEVICE_ID_REQUIRED = "Device ID must not be blank";

	public static final String DEVICE_TYPE_REQUIRED = "Device type must not be blank";

	public static final String ADMIN_ID_REQUIRED = "Admin ID must not be blank";

	public static final String STUDENT_NOT_EXISTS_MESSAGE = "Studnet with this userID does not exist";

	public static final String BLOCKED_BY_ADMIN = "Student cannot login as he/she is blocked by the admin";
